import {retrieveTodosByPendingApi, deleteTodoApi} from './api/TodoApiService'
import { useEffect, useState } from "react"
import { useAuth } from "./security/AuthContext"
import {useNavigate} from 'react-router-dom'
import "./css/ListTodosComponent.css"  // Using the same CSS
...
function PendingComponent() {
    ...
    function refreshTodos() {
        retrieveTodosByPendingApi(username)
            .then(response => {
    ...
    return (
        <div className="container my-5">
            <h1 className="mb-4">Pending TODOS</h1>
