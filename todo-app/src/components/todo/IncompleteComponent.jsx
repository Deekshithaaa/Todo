import { retrieveTodosByNotdoneApi, deleteTodoApi } from './api/TodoApiService'
import { useEffect, useState } from "react"
import { useAuth } from "./security/AuthContext"
import { useNavigate } from 'react-router-dom'
import "./css/ListTodosComponent.css"  // Use the same CSS as ListTodosComponent
...
function IncompleteComponent() {
    ...
    function refreshTodos() {
        retrieveTodosByNotdoneApi(username)
            .then(response => {
    ...
    return (
        <div className="container my-5">
            <h1 className="mb-4">Incomplete TODOS</h1>
