import { retrieveTodosForTodayApi, deleteTodoApi } from './api/TodoApiService';
import { useEffect, useState } from "react"
import { useAuth } from "./security/AuthContext"
import { useNavigate } from 'react-router-dom'
import "./css/ListTodosComponent.css" // Assuming both components use the same styles
...
function TodayComponent() {
    ...
    function refreshTodos() {
        retrieveTodosForTodayApi(username)
        .then(response => {
    ...
    return (
        <div className="container my-5">
            <h1 className="mb-4">Today's TODOS</h1>
