import {retrieveUpcomingTodosApi, deleteTodoApi} from './api/TodoApiService'
import { useEffect, useState } from "react"
import { useAuth } from "./security/AuthContext"
import {useNavigate} from 'react-router-dom'
import "./css/ListTodosComponent.css" // Importing the CSS
...
function UpcomingComponent() {
    ...
    function refreshTodos() {
        retrieveUpcomingTodosApi(username)
        .then(response => {
    ...
    return (
        <div className="container my-5">
            <h1 className="mb-4">Upcoming TODOS</h1>
